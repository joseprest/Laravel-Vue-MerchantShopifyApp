...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', $_SERVER['SHOPIFY_APP_NAME']),
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', $_SERVER['SHOPIFY_API_KEY']),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', $_SERVER['SHOPIFY_API_SECRET']),
    ...
    */
    ...
    'myshopify_domain' => env('SHOPIFY_MYSHOPIFY_DOMAIN', 'merchantgear.myshopify.com'),
    ...
    */
    ...
    'billing_enabled' => (bool) env('SHOPIFY_BILLING_ENABLED', $_SERVER['SHOPIFY_BILLING_ENABLED']),
    ...
    */
    ...
    'billing_freemium_enabled' => (bool) env('SHOPIFY_BILLING_FREEMIUM_ENABLED', $_SERVER['SHOPIFY_BILLING_FREEMIUM_ENABLED']),
